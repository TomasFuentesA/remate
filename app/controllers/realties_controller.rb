class RealtiesController < ApplicationController
  ...
  def realty_params
    params.require(:realty).permit(:street, :number_unit, :unit_estate, :street_type_id, :commune_id, :population_villa, :apple, :property, :latitude, :longitude, :address,
       :type_property_id, :name_realty, :fiscal_destination, :condominio_id, :domain_title, :gp, :tax_appraisal, characteristic_attributes: [ :m2_land, :m2_built , :material], type_realty_attributes: [:tipo,:comment] )
  end
